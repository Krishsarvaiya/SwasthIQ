          ...
          >
            ...
            >
              ...
              <div className="animate-float-subtle">
                ...
                <div className="absolute -bottom-4 -left-4 sm:-left-6 bg-white/95 backdrop-blur-md border border-swasthiq-border p-3.5 rounded-2xl shadow-card flex items-center gap-3 transition-transform duration-200 hover:-translate-y-0.5">
